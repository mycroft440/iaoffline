...
object ModelCatalog {
    val items: List<CatalogModel> = listOf(
        CatalogModel(
            ...
            description = "Modelo menor e indicado para celulares. Boa qualidade com cerca de 5 GB de armazenamento.",
        ...
        CatalogModel(
            ...
            name = "Gemma 4 E4B",
            variant = "Q4_K_M · 5,34 GB",
            description = "Gemma 4 instruído, em quantização de 4 bits. É uma das opções mais práticas do catálogo para execução local em celular.",
            fileName = "gemma-4-E4B-it-Q4_K_M.gguf",
            approximateSizeBytes = 5_340_000_000L,
            downloadUrl = "https://huggingface.co/ggml-org/gemma-4-E4B-it-GGUF/resolve/main/gemma-4-E4B-it-Q4_K_M.gguf?download=true",
